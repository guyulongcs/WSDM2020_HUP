...
class BGRUCell(Layer):
    """Cell class for the BGRU layer.

    # Arguments
        units: Positive integer, dimensionality of the output space.
        weight_dim: dimension of weight vector.
    ...
    def __init__(self, units, weight_dim=0,
                 activation='tanh',
                 ...
                 reset_after=False,
                 **kwargs):
        super(BGRUCell, self).__init__(**kwargs)
        self.units = units
    ...
    def build(self, input_shape):
        ...
        self.x_dim = total_dim-weight_dim

        self.kernel = self.add_weight(shape=(self.x_dim, self.units * 3),
                                      name='kernel',
        ...
        self.recurrent_kernel_w = self.recurrent_kernel[:, self.units * 3:]
        ...
        if self.use_bias:
            ...
            self.input_bias_w = self.input_bias[self.units * 3:]
    ...
    def call(self, inputs, states, training=None):
        ...
        if self.implementation == 1:
            ...
            if self.use_bias:
                ...
                matrix_x = K.bias_add(matrix_x, self.input_bias[:self.units*3])
            ...
            if self.reset_after:
                ...
                recurrent_w = K.dot(h_tm1, self.recurrent_kernel[:, 3 * self.units:])
    ...
    def get_config(self):
        ...
        base_config = super(BGRUCell, self).get_config()
        return dict(list(base_config.items()) + list(config.items()))


class BGRU(RNN):
    """Behavior Gated Recurrent Unit based on GRU
    ...
    def __init__(self, units, weight_dim=0,
        ...
        cell = BGRUCell(units, weight_dim=weight_dim,
    ...
    def call(self, inputs, mask=None, training=None, initial_state=None):
        ...
        return super(BGRU, self).call(inputs,
                                     mask=mask,
                                     training=training,
    ...
    def get_config(self):
        config = {'units': self.units,
                  ...
                  'implementation': self.implementation,
                  'reset_after': self.reset_after}
        base_config = super(BGRU, self).get_config()
